  ...
  */
  ...
  export interface ApprovalDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `approverId`
     * const approvalWithApproverIdOnly = await prisma.approval.findMany({ select: { approverId: true } })
     * 
    **/
  ...
  export type ApprovalWhereUniqueInput = {
    approverId_purchaseId?: ApprovalApproverIdPurchaseIdCompoundUniqueInput
  }
  ...
  export type ApprovalScalarWhereWithAggregatesInput = {
    ...
    approverId?: IntWithAggregatesFilter | number
  ...
  export type ApprovalApproverIdPurchaseIdCompoundUniqueInput = {
    approverId: number
    purchaseId: number
  }
